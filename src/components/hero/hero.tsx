...
export default function Hero({
  ...
  <div className="relative z-10 container mx-auto min-h-[600px] px-4">
    ...
    <div className="absolute bottom-0 left-0 w-full sm:bottom-0 sm:px-0 lg:w-2/3 lg:bottom-2/5 mx-auto space-y-6 flex flex-col px-4 pb-10">
  <SearchCTO
    filters={filters}
  ...
  <div className="flex flex-col sm:flex-row gap-4">
    <Link href="/featured?isFeatured=true">
      <button className="inline-flex h-10 items-center justify-center rounded-full bg-[#C5a243] px-8 py-2 text-sm font-medium text-[#FFFFFF] shadow hover:bg-[#C0B283] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 w-full sm:w-auto transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 overflow-hidden">
