...
//   const getPrevIndex = (index: number) => (index - 1 + slides.length) % slides.length
//   const getNextIndex = (index: number) => (index + 1) % slides.length
...
//   const prevIndex = getPrevIndex(currentSlide)
//   const nextIndex = getNextIndex(currentSlide)

//   const currentCard = slides[currentSlide]
//   const prevCard = slides[prevIndex]
//   const nextCard = slides[nextIndex]

//   const renderCard = (slide: CarouselSlide, position: "prev" | "current" | "next") => {
...
//             opacity: direction === "left" ? 1 : 0.2,
//             zIndex: direction === "left" ? 30 : 5,
//             filter: direction === "left" ? "blur(0px)" : "blur(2px) brightness(0.6)",
//           }
...
//                 ? "translateX(-50%) translateY(-50%) scale(1) rotateY(0deg)"
//                 : "translateX(-20%) translateY(-50%) scale(0.78) rotateY(12deg)",
//             opacity: direction === "right" ? 1 : 0.2,
//             zIndex: direction === "right" ? 30 : 5,
//             filter: direction === "right" ? "blur(0px)" : "blur(2px) brightness(0.6)",
//           }
//         } else {
//           return {
//             ...baseStyle,
...
//             transform:
//               direction === "right"
//                 ? "translateX(-120%) translateY(-50%) scale(0.78) rotateY(12deg)"
//                 : "translateX(20%) translateY(-50%) scale(0.78) rotateY(-12deg)",
//             opacity: 0.2,
//             zIndex: 5,
...
//           ...baseStyle,
//           right: "0",
//           transform: "translateX(20%) translateY(-50%) scale(0.78) rotateY(-12deg)",
//           opacity: 0.35,
//           zIndex: 10,
...
//               : "translateX(-20%) translateY(-50%) scale(0.82) rotateY(12deg)",
//           opacity: 0.55,
//           filter: position === "prev" ? "blur(0.5px) brightness(0.8)" : "blur(0.5px) brightness(0.8)",
//         }
//       : {}
...
//               transition: "all 1000ms cubic-bezier(0.25, 0.46, 0.45, 0.94)",
//               filter: !isCenter ? "brightness(0.5) saturate(0.5)" : "brightness(1) saturate(1)",
//             }}
//           />
...
//                       transform: isTransitioning ? "translateY(1.5rem) scale(0.96)" : "translateY(0) scale(1)",
//                     }}
//                   >
//                     <p
//                       style={{
...
//                       opacity: isTransitioning ? 0 : 1,
//                       transform: isTransitioning ? "translateY(2rem) scale(0.96)" : "translateY(0) scale(1)",
...
//         {renderCard(currentCard, "current")}
    ...
    >
      ...
      >
        ...
        {slides.map((slide, index) => (
          ...
          <React.Fragment key={slide.id}>{renderCard(slide, index)}</React.Fragment>
        ))}
      </div>
